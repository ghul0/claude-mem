"use strict";var Qs=Object.create;var V=Object.defineProperty;var zs=Object.getOwnPropertyDescriptor;var Zs=Object.getOwnPropertyNames;var et=Object.getPrototypeOf,st=Object.prototype.hasOwnProperty;var tt=(n,e)=>{for(var s in e)V(n,s,{get:e[s],enumerable:!0})},Ce=(n,e,s,t)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of Zs(e))!st.call(n,r)&&r!==s&&V(n,r,{get:()=>e[r],enumerable:!(t=zs(e,r))||t.enumerable});return n};var K=(n,e,s)=>(s=n!=null?Qs(et(n)):{},Ce(e||!n||!n.__esModule?V(s,"default",{value:n,enumerable:!0}):s,n)),nt=n=>Ce(V({},"__esModule",{value:!0}),n);var Gt={};tt(Gt,{generateContext:()=>Js,generateContextWithStats:()=>be});module.exports=nt(Gt);var Ks=K(require("path"),1),Ys=require("os"),qs=require("fs");var Oe=require("bun:sqlite");var R=require("path"),ie=require("os"),x=require("fs"),fe=require("url");var N=require("fs"),he=require("crypto"),v=require("path");var rt=null;function ot(n){return(rt??process.stderr.write.bind(process.stderr))(n)}function X(n){ot(n)}var it=process.platform==="win32";function at(n){return n.replace(/^\uFEFF/,"")}function F(n){return JSON.parse(at(n))}function Et(n){(0,N.existsSync)(n)||(0,N.mkdirSync)(n,{recursive:!0})}function oe(n,e){let s=n;try{if((0,N.lstatSync)(n).isSymbolicLink())try{s=(0,N.realpathSync)(n)}catch(d){let m=d instanceof Error?d:new Error(String(d));X(`claude-mem: realpathSync failed for ${n}, resolving symlink manually: ${m.message}
`);let T=(0,N.readlinkSync)(n);s=(0,v.resolve)((0,v.dirname)(n),T)}}catch(d){let m=d.code;if(m!=="ENOENT"&&m!=="ENOTDIR")throw d}Et((0,v.dirname)(s));let t=(0,v.dirname)(s),r=(0,v.basename)(s),o=(0,v.join)(t,`.${r}.${process.pid}.${(0,he.randomBytes)(6).toString("hex")}.tmp`),i=Buffer.from(JSON.stringify(e,null,2)+`
`,"utf-8"),a;try{a=(0,N.statSync)(s).mode&511}catch{}let _;try{_=a!==void 0?(0,N.openSync)(o,"w",a):(0,N.openSync)(o,"w");let d=0;for(;d<i.length;){let m=(0,N.writeSync)(_,i,d,i.length-d);if(m===0)throw new Error(`writeSync stalled at ${d}/${i.length} bytes`);d+=m}if((0,N.fsyncSync)(_),(0,N.closeSync)(_),_=void 0,(0,N.renameSync)(o,s),!it){let m;try{m=(0,N.openSync)(t,"r"),(0,N.fsyncSync)(m)}catch(T){let l=T instanceof Error?T:new Error(String(T));X(`claude-mem: directory fsync failed for ${t}: ${l.message}
`)}finally{if(m!==void 0)try{(0,N.closeSync)(m)}catch{}}}}catch(d){if(_!==void 0)try{(0,N.closeSync)(_)}catch{}try{(0,N.unlinkSync)(o)}catch{}throw d}}var pt={};function _t(){return typeof __dirname<"u"?__dirname:(0,R.dirname)((0,fe.fileURLToPath)(pt.url))}var dt=_t();function mt(){if(process.env.CLAUDE_MEM_DATA_DIR)return process.env.CLAUDE_MEM_DATA_DIR;let n=(0,R.join)((0,ie.homedir)(),".claude-mem"),e=(0,R.join)(n,"settings.json");try{if((0,x.existsSync)(e)){let s=F((0,x.readFileSync)(e,"utf-8")),t=s.env??s;if(t.CLAUDE_MEM_DATA_DIR)return t.CLAUDE_MEM_DATA_DIR}}catch{}return n}var L=mt(),ae=process.env.CLAUDE_CONFIG_DIR||(0,R.join)((0,ie.homedir)(),".claude"),Vt=(0,R.join)(ae,"plugins","marketplaces","thedotmack"),ut=(0,R.join)(L,"logs"),Kt=(0,R.join)(L,"settings.json"),De=(0,R.join)(L,"claude-mem.db"),Tt=(0,R.join)(L,"observer-sessions"),Ee=(0,R.basename)(Tt);function ve(n){(0,x.mkdirSync)(n,{recursive:!0})}function Me(){return(0,R.join)(dt,"..")}var P={dataDir:()=>L,workerPid:()=>(0,R.join)(L,"worker.pid"),serverPid:()=>(0,R.join)(L,".server-beta.pid"),serverPort:()=>(0,R.join)(L,".server-beta.port"),serverRuntime:()=>(0,R.join)(L,".server-beta.runtime.json"),settings:()=>(0,R.join)(L,"settings.json"),database:()=>(0,R.join)(L,"claude-mem.db"),chroma:()=>(0,R.join)(L,"chroma"),combinedCerts:()=>(0,R.join)(L,"combined_certs.pem"),transcriptsConfig:()=>(0,R.join)(L,"transcript-watch.json"),transcriptsState:()=>(0,R.join)(L,"transcript-watch-state.json"),corpora:()=>(0,R.join)(L,"corpora"),supervisorRegistry:()=>(0,R.join)(L,"supervisor.json"),envFile:()=>(0,R.join)(L,".env"),logsDir:()=>ut};var U=require("fs"),Ue=require("path");var de=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(de||{}),_e=null,me=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=P.logsDir();(0,U.existsSync)(e)||(0,U.mkdirSync)(e,{recursive:!0});let s=new Date().toISOString().split("T")[0];this.logFilePath=(0,Ue.join)(e,`claude-mem-${s}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e instanceof Error?e.message:String(e)),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=P.settings();if((0,U.existsSync)(e)){let s=(0,U.readFileSync)(e,"utf-8"),r=(F(s).CLAUDE_MEM_LOG_LEVEL||"INFO").toUpperCase();this.level=de[r]??1}else this.level=1}catch(e){console.error("[LOGGER] Failed to load log level from settings:",e instanceof Error?e.message:String(e)),this.level=1}return this.level}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let s=Object.keys(e);return s.length===0?"{}":s.length<=3?JSON.stringify(e):`{${s.length} keys: ${s.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,s){if(!s)return e;let t=s;if(typeof s=="string")try{t=JSON.parse(s)}catch{t=s}if(e==="Bash"&&t.command)return`${e}(${t.command})`;if(t.file_path)return`${e}(${t.file_path})`;if(t.notebook_path)return`${e}(${t.notebook_path})`;if(e==="Glob"&&t.pattern)return`${e}(${t.pattern})`;if(e==="Grep"&&t.pattern)return`${e}(${t.pattern})`;if(t.url)return`${e}(${t.url})`;if(t.query)return`${e}(${t.query})`;if(e==="Task"){if(t.subagent_type)return`${e}(${t.subagent_type})`;if(t.description)return`${e}(${t.description})`}return e==="Skill"&&t.skill?`${e}(${t.skill})`:e==="LSP"&&t.operation?`${e}(${t.operation})`:e}formatTimestamp(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),a=String(e.getSeconds()).padStart(2,"0"),_=String(e.getMilliseconds()).padStart(3,"0");return`${s}-${t}-${r} ${o}:${i}:${a}.${_}`}log(e,s,t,r,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),a=de[e].padEnd(5),_=s.padEnd(6),d="";r?.correlationId?d=`[${r.correlationId}] `:r?.sessionId&&(d=`[session-${r.sessionId}] `);let m="";if(o!=null)if(o instanceof Error)m=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`;else if(this.getLevel()===0&&typeof o=="object")try{m=`
`+JSON.stringify(o,null,2)}catch{m=" "+this.formatData(o)}else m=" "+this.formatData(o);let T="";if(r){let{sessionId:I,memorySessionId:b,correlationId:g,...O}=r;Object.keys(O).length>0&&(T=` {${Object.entries(O).map(([f,M])=>`${f}=${M}`).join(", ")}}`)}let l=`[${i}] [${a}] [${_}] ${d}${t}${T}${m}`;if(this.logFilePath)try{(0,U.appendFileSync)(this.logFilePath,l+`
`,"utf8")}catch(I){let b=I instanceof Error?I:new Error(String(I));X(`[LOGGER] Failed to write to log file: ${b.message}
${b.stack??""}
`)}else X(l+`
`)}debug(e,s,t,r){this.log(0,e,s,t,r)}info(e,s,t,r){this.log(1,e,s,t,r)}warn(e,s,t,r){this.log(2,e,s,t,r)}setErrorSink(e){_e=e}error(e,s,t,r){this.log(3,e,s,t,r),this.routeErrorToSink(s,t,r)}routeErrorToSink(e,s,t){try{if(!_e||!(t instanceof Error))return;_e(t)}catch{}}dataIn(e,s,t,r){this.info(e,`\u2192 ${s}`,t,r)}dataOut(e,s,t,r){this.info(e,`\u2190 ${s}`,t,r)}success(e,s,t,r){this.info(e,`\u2713 ${s}`,t,r)}failure(e,s,t,r){this.error(e,`\u2717 ${s}`,t,r)}},E=new me;var xe=require("crypto");var Xe=require("os");var Y=require("fs"),w=K(require("path"),1);var B={isWorktree:!1,worktreeName:null,parentRepoPath:null,parentProjectName:null};function ye(n){let e=w.default.join(n,".git"),s;try{s=(0,Y.statSync)(e)}catch(m){return m instanceof Error&&m.code!=="ENOENT"&&E.warn("GIT","Unexpected error checking .git",{error:m instanceof Error?m.message:String(m)}),B}if(!s.isFile())return B;let t;try{t=(0,Y.readFileSync)(e,"utf-8").trim()}catch(m){return E.warn("GIT","Failed to read .git file",{error:m instanceof Error?m.message:String(m)}),B}let r=t.match(/^gitdir:\s*(.+)$/);if(!r)return B;let i=w.default.resolve(w.default.dirname(e),r[1]).match(/^(.+)[/\\]\.git[/\\]worktrees[/\\]([^/\\]+)$/);if(!i)return B;let a=i[1],_=w.default.basename(n),d=w.default.basename(a);return{isWorktree:!0,worktreeName:_,parentRepoPath:a,parentProjectName:d}}function Fe(n){return n==="~"||n.startsWith("~/")?n.replace(/^~/,(0,Xe.homedir)()):n}function ct(n){if(!n||n.trim()==="")return E.warn("PROJECT_NAME","Empty cwd provided, using fallback",{cwd:n}),"unknown-project";let e=Fe(n).replace(/\/+$/,"");if(e===""||e==="/"){if(process.platform==="win32"){let s=n.match(/^([A-Z]):\\/i);if(s){let r=`drive-${s[1].toUpperCase()}`;return E.info("PROJECT_NAME","Drive root detected",{cwd:n,projectName:r}),r}}return E.warn("PROJECT_NAME","Root directory detected, using fallback",{cwd:n}),"unknown-project"}return e}function ue(n){let e=ct(n);if(!n)return{primary:e,parent:null,isWorktree:!1,allProjects:[e]};let s=Fe(n),t=ye(s);return t.isWorktree?{primary:e,parent:t.parentProjectName,isWorktree:!0,allProjects:[e]}:{primary:e,parent:null,isWorktree:!1,allProjects:[e]}}function we(n,e,s){return(0,xe.createHash)("sha256").update([n||"",e||"",s||""].join("\0")).digest("hex").slice(0,16)}var Te=["active","weak","stale","superseded","deprecated"];var ke=["active","weak","stale"];var q=require("fs"),ce=require("path"),le=require("os");var pe={HEALTH_CHECK:3e3,API_REQUEST:3e4,HOOK_READINESS_WAIT:1e4,POST_SPAWN_WAIT:15e3,READINESS_WAIT:3e4,PORT_IN_USE_WAIT:3e3,POWERSHELL_COMMAND:1e4,WINDOWS_MULTIPLIER:1.5};function Ge(n){return process.platform==="win32"?Math.round(n*pe.WINDOWS_MULTIPLIER):n}var k=class{static DEFAULTS={CLAUDE_MEM_MODEL:"openai-codex/gpt-5.4-mini",CLAUDE_MEM_CONTEXT_OBSERVATIONS:"50",CLAUDE_MEM_WORKER_PORT:String(37700+(process.getuid?.()??77)%100),CLAUDE_MEM_WORKER_HOST:"127.0.0.1",CLAUDE_MEM_API_TIMEOUT_MS:String(Ge(pe.API_REQUEST)),CLAUDE_MEM_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_MEM_PROVIDER:"pi",CLAUDE_MEM_CLAUDE_AUTH_METHOD:"subscription",CLAUDE_MEM_PI_MODEL:"openai-codex/gpt-5.4-mini",CLAUDE_MEM_PI_THINKING:"off",CLAUDE_MEM_PI_TIMEOUT_MS:"120000",CLAUDE_MEM_PI_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_PI_MAX_TOKENS:"100000",CLAUDE_MEM_GEMINI_API_KEY:"",CLAUDE_MEM_GEMINI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_RATE_LIMITING_ENABLED:"true",CLAUDE_MEM_GEMINI_MAX_CONTEXT_MESSAGES:"20",CLAUDE_MEM_GEMINI_MAX_TOKENS:"100000",CLAUDE_MEM_OPENROUTER_API_KEY:"",CLAUDE_MEM_OPENROUTER_MODEL:"xiaomi/mimo-v2-flash:free",CLAUDE_MEM_OPENROUTER_BASE_URL:"",CLAUDE_MEM_OPENROUTER_SITE_URL:"",CLAUDE_MEM_OPENROUTER_APP_NAME:"claude-mem",CLAUDE_MEM_DATA_DIR:(0,ce.join)((0,le.homedir)(),".claude-mem"),CLAUDE_MEM_LOG_LEVEL:"INFO",CLAUDE_MEM_PYTHON_VERSION:"3.13",CLAUDE_CODE_PATH:"",CLAUDE_MEM_MODE:"code",CLAUDE_MEM_CONTEXT_SHOW_READ_TOKENS:"false",CLAUDE_MEM_CONTEXT_SHOW_WORK_TOKENS:"false",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_AMOUNT:"false",CLAUDE_MEM_CONTEXT_SHOW_SAVINGS_PERCENT:"true",CLAUDE_MEM_CONTEXT_FULL_COUNT:"0",CLAUDE_MEM_CONTEXT_FULL_FIELD:"narrative",CLAUDE_MEM_CONTEXT_SESSION_COUNT:"10",CLAUDE_MEM_CONTEXT_SHOW_LAST_SUMMARY:"true",CLAUDE_MEM_CONTEXT_SHOW_LAST_MESSAGE:"false",CLAUDE_MEM_CONTEXT_SHOW_TERMINAL_OUTPUT:"true",CLAUDE_MEM_WELCOME_HINT_ENABLED:"true",CLAUDE_MEM_FOLDER_CLAUDEMD_ENABLED:"false",CLAUDE_MEM_FOLDER_USE_LOCAL_MD:"false",CLAUDE_MEM_TRANSCRIPTS_ENABLED:"true",CLAUDE_MEM_TRANSCRIPTS_CONFIG_PATH:(0,ce.join)((0,le.homedir)(),".claude-mem","transcript-watch.json"),CLAUDE_MEM_CODEX_TRANSCRIPT_INGESTION:"false",CLAUDE_MEM_MAX_CONCURRENT_AGENTS:"2",CLAUDE_MEM_HOOK_FAIL_LOUD_THRESHOLD:"3",CLAUDE_MEM_EXCLUDED_PROJECTS:"",CLAUDE_MEM_FOLDER_MD_EXCLUDE:"[]",CLAUDE_MEM_FOLDER_MD_SKELETON_DENYLIST:"[]",CLAUDE_MEM_SEMANTIC_INJECT:"false",CLAUDE_MEM_SEMANTIC_INJECT_LIMIT:"5",CLAUDE_MEM_TIER_ROUTING_ENABLED:"true",CLAUDE_MEM_TIER_SIMPLE_MODEL:"haiku",CLAUDE_MEM_TIER_SUMMARY_MODEL:"",CLAUDE_MEM_TIER_FAST_MODEL:"haiku",CLAUDE_MEM_TIER_SMART_MODEL:"sonnet",CLAUDE_MEM_CHROMA_ENABLED:"true",CLAUDE_MEM_CHROMA_MODE:"local",CLAUDE_MEM_CHROMA_HOST:"127.0.0.1",CLAUDE_MEM_CHROMA_PORT:"8000",CLAUDE_MEM_CHROMA_SSL:"false",CLAUDE_MEM_CHROMA_API_KEY:"",CLAUDE_MEM_CHROMA_TENANT:"default_tenant",CLAUDE_MEM_CHROMA_DATABASE:"default_database",CLAUDE_MEM_CHROMA_PREWARM_TIMEOUT_MS:"120000",CLAUDE_MEM_TELEGRAM_ENABLED:"true",CLAUDE_MEM_TELEGRAM_BOT_TOKEN:"",CLAUDE_MEM_TELEGRAM_CHAT_ID:"",CLAUDE_MEM_TELEGRAM_TRIGGER_TYPES:"security_alert",CLAUDE_MEM_TELEGRAM_TRIGGER_CONCEPTS:"",CLAUDE_MEM_QUEUE_ENGINE:"sqlite",CLAUDE_MEM_REDIS_URL:"",CLAUDE_MEM_REDIS_HOST:"127.0.0.1",CLAUDE_MEM_REDIS_PORT:"6379",CLAUDE_MEM_REDIS_MODE:"external",CLAUDE_MEM_QUEUE_REDIS_PREFIX:`claude_mem_${process.env.CLAUDE_MEM_WORKER_PORT??String(37700+(process.getuid?.()??77)%100)}`,CLAUDE_MEM_AUTH_MODE:"api-key",CLAUDE_MEM_RUNTIME:"worker",CLAUDE_MEM_SERVER_URL:`http://127.0.0.1:${process.env.CLAUDE_MEM_SERVER_PORT??String(37877+(process.getuid?.()??77)%100)}`,CLAUDE_MEM_SERVER_API_KEY:"",CLAUDE_MEM_SERVER_PROJECT_ID:"",CLAUDE_MEM_SERVER_BETA_URL:`http://127.0.0.1:${process.env.CLAUDE_MEM_SERVER_PORT??String(37877+(process.getuid?.()??77)%100)}`,CLAUDE_MEM_SERVER_BETA_API_KEY:"",CLAUDE_MEM_SERVER_BETA_PROJECT_ID:"",CLAUDE_MEM_OBSERVATION_RECONCILIATION_ENABLED:"false",CLAUDE_MEM_OBSERVATION_RECONCILIATION_APPLY:"false",CLAUDE_MEM_OBSERVATION_RECONCILIATION_MAX_PROJECT_OBS:"5000",CLAUDE_MEM_OBSERVATION_RECONCILIATION_VECTOR_TOP_K:"200",CLAUDE_MEM_OBSERVATION_RECONCILIATION_DETERMINISTIC_RECENT_LIMIT:"200",CLAUDE_MEM_OBSERVATION_RECONCILIATION_DETERMINISTIC_TOP:"200",CLAUDE_MEM_OBSERVATION_RECONCILIATION_CANDIDATE_CHUNK_SIZE:"200",CLAUDE_MEM_OBSERVATION_RECONCILIATION_MAX_CANDIDATES:"40",CLAUDE_MEM_OBSERVATION_RECONCILIATION_FULL_SCAN_LLM:"false",CLAUDE_MEM_OBSERVATION_RECONCILIATION_MIN_APPLY_CONFIDENCE:"0.90",CLAUDE_MEM_OBSERVATION_RECONCILIATION_MIN_WEAK_CONFIDENCE:"0.65",CLAUDE_MEM_OBSERVATION_RECONCILIATION_MIN_TERMINAL_EVIDENCE_CHARS:"40",CLAUDE_MEM_OBSERVATION_RECONCILIATION_MODEL:"",CLAUDE_MEM_OBSERVATION_RECONCILIATION_SELECTOR_MODEL:"",CLAUDE_MEM_OBSERVATION_RECONCILIATION_CLASSIFIER_MODEL:"",CLAUDE_MEM_OBSERVATION_RECONCILIATION_DAILY_BUDGET_USD:"0",CLAUDE_MEM_OBSERVATION_RECONCILIATION_KILL_SWITCH:"false",CLAUDE_MEM_OBSERVATION_RECONCILIATION_CONCURRENCY:"1",CLAUDE_MEM_FALLBACK_CHAIN:"codex-mini,codex-spark",CLAUDE_MEM_GEMINI_CLI_MODEL:"gemini-2.5-flash-lite",CLAUDE_MEM_GEMINI_CLI_MIN_SPACING_MS:"6100",CLAUDE_MEM_ANTIGRAVITY_CLI_MIN_SPACING_MS:"2000",CLAUDE_MEM_PROVIDER_COOLDOWN_MS:"3600000",CLAUDE_MEM_COOLDOWN_QUOTA_EXHAUSTED_MS:"3600000",CLAUDE_MEM_COOLDOWN_RATE_LIMIT_MS:"60000",CLAUDE_MEM_COOLDOWN_TRANSIENT_MS:"90000",CLAUDE_MEM_COOLDOWN_UNRECOVERABLE_MS:"3600000",CLAUDE_MEM_COOLDOWN_AUTH_INVALID_MS:"86400000",CLAUDE_MEM_VALIDATION_RETRIES:"2"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return process.env[e]??this.DEFAULTS[e]}static getInt(e){let s=this.get(e);return parseInt(s,10)}static applyEnvOverrides(e){let s={...e};for(let t of Object.keys(this.DEFAULTS))process.env[t]!==void 0&&(s[t]=process.env[t]);return s}static applyToProcessEnv(e){for(let s of Object.keys(this.DEFAULTS))process.env[s]===void 0&&e[s]!==void 0&&(process.env[s]=String(e[s]))}static loadFromFile(e,s=!0){try{if(!(0,q.existsSync)(e)){let a=this.getAllDefaults();try{oe(e,a),console.warn("[SETTINGS] Created settings file with defaults:",e)}catch(_){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,_ instanceof Error?_.message:String(_))}return s?this.applyEnvOverrides(a):a}let t=(0,q.readFileSync)(e,"utf-8"),r=F(t),o=r;if(r.env&&typeof r.env=="object"){o=r.env;try{oe(e,o),console.warn("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a instanceof Error?a.message:String(a))}}let i={...this.DEFAULTS};for(let a of Object.keys(this.DEFAULTS))o[a]!==void 0&&(i[a]=o[a]);return s?this.applyEnvOverrides(i):i}catch(t){console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t instanceof Error?t.message:String(t));let r=this.getAllDefaults();return s?this.applyEnvOverrides(r):r}}};function Pe(){return k.getBool("CLAUDE_MEM_OBSERVATION_RECONCILIATION_ENABLED")}var lt=new Set(Te),Ne=class extends Error{constructor(s,t){super(s);this.invalid=t;this.name="StatusFilterError"}invalid};function Be(n,e={}){if(!(e.featureEnabled??Pe()))return{statuses:[...Te],filterApplied:!1};if(n==null||n==="")return{statuses:[...ke],filterApplied:!0};let t=n.split(",").map(o=>o.trim()).filter(Boolean),r=t.filter(o=>!lt.has(o));if(r.length>0)throw new Ne(`Unknown status values: ${r.join(",")}`,r);return{statuses:t,filterApplied:!0}}function He(n,e={}){let s=e.columnExpr??"COALESCE(status, 'active')";if(n.length===0)return{sql:"1=0",params:[]};let t=n.map(()=>"?").join(",");return{sql:`${s} IN (${t})`,params:[...n]}}var p="claude";function Nt(n){return n.trim().toLowerCase().replace(/\s+/g,"-")}function C(n){if(!n)return p;let e=Nt(n);return e?e==="transcript"||e.includes("codex")?"codex":e.includes("cursor")?"cursor":e.includes("claude")?"claude":e:p}function $e(n){let e=["claude","codex","cursor"];return[...n].sort((s,t)=>{let r=e.indexOf(s),o=e.indexOf(t);return r!==-1||o!==-1?r===-1?1:o===-1?-1:r-o:s.localeCompare(t)})}function je(n,e,s,t,r){let o=Date.now()-t,i=r!==void 0?"up.session_db_id = ?":"up.content_session_id = ?",a=r??e;return n.prepare(`
    SELECT
      up.*,
      s.memory_session_id,
      s.project,
    ...
    LIMIT 1
  `).get(a,s,o)??void 0}var Ke=["private","claude-mem-context","system_instruction","system-instruction","persisted-output","system-reminder"],We=new RegExp(`<(${Ke.join("|")})\\b[^>]*>[\\s\\S]*?</\\1>`,"g"),Ye=/<system-reminder>[\s\S]*?<\/system-reminder>/g,Ve=100;function It(n){let e=Object.fromEntries(Ke.map(r=>[r,0]));We.lastIndex=0;let s=0,t=n.replace(We,(r,o)=>(e[o]=(e[o]??0)+1,s+=1,""));return s>Ve&&E.warn("SYSTEM","tag count exceeds limit",void 0,{tagCount:s,maxAllowed:Ve,contentLength:n.length}),{stripped:t.trim(),counts:e}}function qe(n){return It(n).stripped}var Ot=["task-notification"],gn=new RegExp(`^\\s*<(${Ot.join("|")})\\b[^>]*>(?:(?!<\\1\\b|</\\1\\b)[\\s\\S])*</\\1>\\s*$`),An=256*1024;var Ie=4e3;function J(n){let e=n.trim(),t=qe(n).trim()||e;return t.length<=Ie?t:(E.debug("DB","Truncated stored prompt text to the configured cap",{originalLength:t.length,storedLength:Ie}),`${t.slice(0,Ie-1)}\u2026`)}var St=require("bun:sqlite");var Rt=5e3,gt=4194304;function At(n){return n.prepare(`
    SELECT name
    FROM sqlite_master
    WHERE type = 'table'
      AND name NOT LIKE 'sqlite_%'
    LIMIT 1
  `).get()!=null}function G(n,e,s){try{n.run(e)}catch(t){let r=t instanceof Error?t:new Error(String(t));throw E.warn("DB",`Failed to apply SQLite pragma ${s}`,{sql:e},r),t}}function Je(n,e={}){let{enableWal:s=!0,enableIncrementalAutoVacuum:t=!0}=e;G(n,`PRAGMA busy_timeout = ${Rt}`,"busy_timeout"),G(n,"PRAGMA foreign_keys = ON","foreign_keys"),G(n,"PRAGMA synchronous = NORMAL","synchronous"),G(n,`PRAGMA journal_size_limit = ${gt}`,"journal_size_limit"),t&&!At(n)&&G(n,"PRAGMA auto_vacuum = INCREMENTAL","auto_vacuum"),s&&G(n,"PRAGMA journal_mode = WAL","journal_mode")}var ze=33;var Qe=new WeakSet;function Ze(n){if(Qe.has(n))return;n.run(`
  ...
  `),Qe.add(n)}var Q=class{constructor(e){this.db=e}db;runAllMigrations(){this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.createObservationFeedbackTable(),this.addSessionPlatformSourceColumn(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.rebuildPendingMessagesForSelfHealingClaim(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.dropWorkerPidColumn(),this.createServerOwnedTables(),this.rebuildPendingMessagesForFinalQueueSchema(),this.addObservationReconciliationSchema(),this.addObservationStatusAuditTable(),this.addObservationReconcileCostsTable()}initializeSchema(){this.db.run(`
    ...
    `),this.db.run("CREATE INDEX IF NOT EXISTS idx_observation_reconcile_costs_job ON observation_reconcile_costs(job_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observation_reconcile_costs_created ON observation_reconcile_costs(created_at_epoch DESC)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_observation_reconcile_costs_project_created ON observation_reconcile_costs(project, created_at_epoch DESC)"),this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(37,new Date().toISOString()),E.debug("DB","Observation reconcile costs table initialized (migration 37)"))}};var z=class{db;constructor(e=De){e instanceof Oe.Database?this.db=e:(e!==":memory:"&&ve(L),this.db=new Oe.Database(e)),Je(this.db),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.addFailedAtEpochColumn(),this.addOnUpdateCascadeToForeignKeys(),this.addObservationContentHashColumn(),this.addSessionCustomTitleColumn(),this.addSessionPlatformSourceColumn(),this.addObservationModelColumns(),this.ensureMergedIntoProjectColumns(),this.addObservationSubagentColumns(),this.addObservationsUniqueContentHashIndex(),this.addObservationsMetadataColumn(),this.dropDeadPendingMessagesColumns(),this.ensurePendingMessagesToolUseIdColumn(),this.dropWorkerPidColumn(),this.ensureSDKSessionsPlatformContentIdentity(),this.ensureUserPromptsSessionDbId(),this.ensurePendingMessagesSessionToolUniqueIndex(),new Q(this.db).runAllMigrations()}getIndexColumns(e){return this.db.query(`PRAGMA index_info(${JSON.stringify(e)})`).all().map(s=>s.name)}hasUniqueIndexOnColumns(e,s){return this.db.query(`PRAGMA index_list(${e})`).all().some(r=>{if(r.unique!==1)return!1;let o=this.getIndexColumns(r.name);return o.length===s.length&&o.every((i,a)=>i===s[a])})}resolvePromptSessionDbId(e,s,t){if(s!==void 0)return s;let r=t?C(t):void 0;return r?this.db.prepare(`
        SELECT id
        FROM sdk_sessions
    ...
    `),this.db.run("DROP TABLE sdk_sessions"),this.db.run("ALTER TABLE sdk_sessions_new RENAME TO sdk_sessions"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_claude_id ON sdk_sessions(content_session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_sdk_id ON sdk_sessions(memory_session_id)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_project ON sdk_sessions(project)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_status ON sdk_sessions(status)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_started ON sdk_sessions(started_at_epoch DESC)"),this.db.run("CREATE INDEX IF NOT EXISTS idx_sdk_sessions_platform_source ON sdk_sessions(platform_source)"),this.db.run("CREATE UNIQUE INDEX IF NOT EXISTS ux_sdk_sessions_platform_content ON sdk_sessions(platform_source, content_session_id)"),e||this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(33,new Date().toISOString())}ensureUserPromptsSessionDbId(){let e=this.db.prepare("SELECT version FROM schema_versions WHERE version = ?").get(34);if(this.db.query("SELECT name FROM sqlite_master WHERE type='table' AND name='user_prompts'").all().length===0){this.db.prepare("INSERT OR IGNORE INTO schema_versions (version, applied_at) VALUES (?, ?)").run(34,new Date().toISOString());return}let r=this.db.query("PRAGMA table_info(user_prompts)").all().some(d=>d.name==="session_db_id"),i=this.db.query("PRAGMA foreign_key_list(user_prompts)").all().some(d=>d.table==="sdk_sessions"&&d.from==="content_session_id");if(e&&r&&!i)return;let a=this.db.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='user_prompts_fts'").all().length>0,_=r?`COALESCE(up.session_db_id, (
          ...
          END, s.id
          LIMIT 1
        )`;this.db.run("PRAGMA foreign_keys = OFF"),this.db.run("BEGIN TRANSACTION");try{this.rebuildUserPromptsWithSessionDbId(e,_,a),this.db.run("COMMIT")}catch(d){this.db.run("ROLLBACK");let m=d instanceof Error?d:new Error(String(d));throw E.error("DB","Failed to rebuild user_prompts with session_db_id, rolled back",{},m),d}finally{this.db.run("PRAGMA foreign_keys = ON")}}rebuildUserPromptsWithSessionDbId(e,s,t){this.db.run("DROP TRIGGER IF EXISTS user_prompts_ai"),this.db.run("DROP TRIGGER IF EXISTS user_prompts_ad"),this.db.run("DROP TRIGGER IF EXISTS user_prompts_au"),this.db.run("DROP TABLE IF EXISTS user_prompts_new"),this.db.run(`
    ...
    `).get(e);if(!r)throw new Error(`Session ${e} not found in sdk_sessions`);r.memory_session_id!==s&&(this.db.prepare(`
      ...
      WHERE project IS NOT NULL AND project != ''
        AND project != ?
    `,r=[Ee];return s&&(t+=" AND COALESCE(platform_source, ?) = ?",r.push(p,s)),t+=" ORDER BY project ASC",this.db.prepare(t).all(...r).map(i=>i.project)}getProjectCatalog(){let e=this.db.prepare(`
      SELECT
    ...
    `).all(Ee),s=[],t=new Set,r={};for(let i of e){let a=C(i.platform_source);r[a]||(r[a]=[]),r[a].includes(i.project)||r[a].push(i.project),t.has(i.project)||(t.add(i.project),s.push(i.project))}let o=$e(Object.keys(r));return{projects:s,sources:o,projectsBySource:Object.fromEntries(o.map(i=>[i,r[i]||[]]))}}getLatestUserPrompt(e,s){let t=this.resolvePromptSessionDbId(e,s),r=t!==null?"up.session_db_id = ?":"up.content_session_id = ?",o=t!==null?t:e;return this.db.prepare(`
      ...
      ORDER BY up.created_at_epoch DESC
      LIMIT 1
    `).get(o)}findRecentDuplicateUserPrompt(e,s,t,r){return je(this.db,e,J(s),t,this.resolvePromptSessionDbId(e,r)??void 0)}getRecentSessionsWithStatus(e,s=3,t){let r=[e],o="";return t&&(o=`AND COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`,r.push(C(t))),r.push(s),this.db.prepare(`
      SELECT * FROM (
        SELECT
          s.memory_session_id,
          s.status,
    ...
    `).get(e,C(s))||null:this.db.prepare(`
        ...
        FROM observations
        WHERE id = ?
      `).get(e)||null}getObservationsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i,type:a,concepts:_,files:d}=s,m=t==="relevance",T=m?"":`ORDER BY o.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,l=r&&!m?`LIMIT ${r}`:"",I=e.map(()=>"?").join(","),b=[...e],g=[];if(o&&(g.push("o.project = ?"),b.push(o)),i&&(g.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),b.push(C(i))),a)if(Array.isArray(a)){let c=a.map(()=>"?").join(",");g.push(`o.type IN (${c})`),b.push(...a)}else g.push("o.type = ?"),b.push(a);if(_){let c=Array.isArray(_)?_:[_],h=c.map(()=>"EXISTS (SELECT 1 FROM json_each(o.concepts) WHERE value = ?)");b.push(...c),g.push(`(${h.join(" OR ")})`)}if(d){let c=Array.isArray(d)?d:[d],h=c.map(()=>"(EXISTS (SELECT 1 FROM json_each(o.files_read) WHERE value LIKE ?) OR EXISTS (SELECT 1 FROM json_each(o.files_modified) WHERE value LIKE ?))");c.forEach(Le=>{b.push(`%${Le}%`,`%${Le}%`)}),g.push(`(${h.join(" OR ")})`)}let O=Be(void 0);if(O.filterApplied){let c=He(O.statuses);g.push(c.sql),b.push(...c.params)}let S=g.length>0?`WHERE o.id IN (${I}) AND ${g.join(" AND ")}`:`WHERE o.id IN (${I})`,M=this.db.prepare(`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions s ON s.memory_session_id = o.memory_session_id
      ${S}
      ${T}
      ${l}
    `).all(...b);if(!m)return M;let A=new Map(M.map(c=>[c.id,c])),y=e.map(c=>A.get(c)).filter(c=>!!c);return r?y.slice(0,r):y}getSummaryForSession(e,s){let t=[e],r="";return s&&(r=`
        AND EXISTS (
          SELECT 1
    ...
    `).get(e).count}createSDKSession(e,s,t,r,o){let i=new Date,a=i.getTime(),_=o?C(o):p,d=J(t),m=this.db.prepare(`
      SELECT id, platform_source
      FROM sdk_sessions
      WHERE COALESCE(NULLIF(platform_source, ''), ?) = ?
        AND content_session_id = ?
    `).get(p,_,e);if(m)return s&&this.db.prepare(`
          UPDATE sdk_sessions SET project = ?
          WHERE id = ? AND (project IS NULL OR project = '')
        `).run(s,m.id),r&&this.db.prepare(`
          UPDATE sdk_sessions SET custom_title = ?
          WHERE id = ? AND custom_title IS NULL
        `).run(r,m.id),m.id;let T=this.db.prepare(`
      INSERT INTO sdk_sessions
      (content_session_id, memory_session_id, project, platform_source, user_prompt, custom_title, started_at, started_at_epoch, status)
      VALUES (?, NULL, ?, ?, ?, ?, ?, ?, 'active')
    `).run(e,s,_,d,r||null,i.toISOString(),a);return Number(T.lastInsertRowid)}saveUserPrompt(e,s,t,r){let o=new Date,i=o.getTime(),a=J(t),_=this.resolvePromptSessionDbId(e,r);return this.db.prepare(`
    ...
    `).run(_,e,s,a,o.toISOString(),i).lastInsertRowid}getUserPrompt(e,s,t){let r=this.resolvePromptSessionDbId(e,t);return r!==null?this.db.prepare(`
      ...
      LIMIT 1
    `).get(e,s)?.prompt_text??null}storeObservation(e,s,t,r,o=0,i,a){let _=this.storeObservations(e,s,[t],null,r,o,i,a);return{id:_.observationIds[0],createdAtEpoch:_.createdAtEpoch}}storeSummary(e,s,t,r,o=0,i){let a=i??Date.now(),_=new Date(a).toISOString(),m=this.db.prepare(`
      INSERT INTO session_summaries
      (memory_session_id, project, request, investigated, learned, completed,
       next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).run(e,s,t.request,t.investigated,t.learned,t.completed,t.next_steps,t.notes,r||null,o,_,a);return{id:Number(m.lastInsertRowid),createdAtEpoch:a}}storeObservations(e,s,t,r,o,i=0,a,_){let d=a??Date.now(),m=new Date(d).toISOString();return this.db.transaction(()=>{let l=[],I=this.db.prepare(`
        ...
        RETURNING id
      `),b=this.db.prepare("SELECT id FROM observations WHERE memory_session_id = ? AND content_hash = ?");for(let O of t){let S=we(e,O.title,O.narrative),f=I.get(e,s,O.type,O.title,O.subtitle,JSON.stringify(O.facts),O.narrative,JSON.stringify(O.concepts),JSON.stringify(O.files_read),JSON.stringify(O.files_modified),o||null,i,O.agent_type??null,O.agent_id??null,S,m,d,_||null,O.metadata??null);if(f){l.push(f.id);continue}let M=b.get(e,S);if(!M)throw new Error(`storeObservations: ON CONFLICT without existing row for content_hash=${S}`);l.push(M.id)}let g=null;if(r){let S=this.db.prepare(`
          INSERT INTO session_summaries
          (memory_session_id, project, request, investigated, learned, completed,
           next_steps, notes, prompt_number, discovery_tokens, created_at, created_at_epoch)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).run(e,s,r.request,r.investigated,r.learned,r.completed,r.next_steps,r.notes,o||null,i,m,d);g=Number(S.lastInsertRowid)}return{observationIds:l,summaryId:g,createdAtEpoch:d}})()}getSessionSummariesByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i}=s,a=t==="relevance",_=a?"":`ORDER BY ss.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,d=r&&!a?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),T=[...e],l=[];o&&(l.push("ss.project = ?"),T.push(o)),i&&(l.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),T.push(C(i)));let I=l.length>0?`AND ${l.join(" AND ")}`:"",g=this.db.prepare(`
      SELECT ss.*
      ...
      ${_}
      ${d}
    `).all(...T);if(!a)return g;let O=new Map(g.map(f=>[f.id,f])),S=e.map(f=>O.get(f)).filter(f=>!!f);return r?S.slice(0,r):S}getUserPromptsByIds(e,s={}){if(e.length===0)return[];let{orderBy:t="date_desc",limit:r,project:o,platformSource:i}=s,a=t==="relevance",_=a?"":`ORDER BY up.created_at_epoch ${t==="date_asc"?"ASC":"DESC"}`,d=r?`LIMIT ${r}`:"",m=e.map(()=>"?").join(","),T=[...e],l=[];o&&(l.push("s.project = ?"),T.push(o)),i&&(l.push(`COALESCE(NULLIF(s.platform_source, ''), '${p}') = ?`),T.push(C(i)));let I=l.length>0?`AND ${l.join(" AND ")}`:"",g=this.db.prepare(`
      SELECT
        up.*,
        s.project,
        s.memory_session_id,
      ...
      ${_}
      ${d}
    `).all(...T);if(!a)return g;let O=new Map(g.map(S=>[S.id,S]));return e.map(S=>O.get(S)).filter(S=>!!S)}getTimelineAroundTimestamp(e,s=10,t=10,r,o){return this.getTimelineAroundObservation(null,e,s,t,r,o)}getTimelineAroundObservation(e,s,t=10,r=10,o,i){let a=i?C(i):void 0,_=(A,y)=>{let c=[],h=[];return o&&(c.push(`${A}.project = ?`),h.push(o)),a&&(c.push(`COALESCE(NULLIF(${y}.platform_source, ''), '${p}') = ?`),h.push(a)),{clause:c.length>0?`AND ${c.join(" AND ")}`:"",params:h}},d=_("o","src"),m=_("ss","src"),T=_("s","s"),l,I;if(e!==null){let A=`
      ...
      `,y=`
        ...
        ORDER BY o.id ASC
        LIMIT ?
      `;try{let c=this.db.prepare(A).all(e,...d.params,t+1),h=this.db.prepare(y).all(e,...d.params,r+1);if(c.length===0&&h.length===0)return{observations:[],sessions:[],prompts:[]};l=c.length>0?c[c.length-1].created_at_epoch:s,I=h.length>0?h[h.length-1].created_at_epoch:s}catch(c){return c instanceof Error?E.error("DB","Error getting boundary observations",{project:o},c):E.error("DB","Error getting boundary observations with non-Error",{},new Error(String(c))),{observations:[],sessions:[],prompts:[]}}}else{let A=`
      ...
      `,y=`
        ...
        LIMIT ?
      `;try{let c=this.db.prepare(A).all(s,...d.params,t),h=this.db.prepare(y).all(s,...d.params,r+1);if(c.length===0&&h.length===0)return{observations:[],sessions:[],prompts:[]};l=c.length>0?c[c.length-1].created_at_epoch:s,I=h.length>0?h[h.length-1].created_at_epoch:s}catch(c){return c instanceof Error?E.error("DB","Error getting boundary timestamps",{project:o},c):E.error("DB","Error getting boundary timestamps with non-Error",{},new Error(String(c))),{observations:[],sessions:[],prompts:[]}}}let b=`
      SELECT o.*
      FROM observations o
      LEFT JOIN sdk_sessions src ON src.memory_session_id = o.memory_session_id
    ...
    `,S=this.db.prepare(b).all(l,I,...d.params),f=this.db.prepare(g).all(l,I,...m.params),M=this.db.prepare(O).all(l,I,...T.params);return{observations:S,sessions:f.map(A=>({id:A.id,memory_session_id:A.memory_session_id,project:A.project,request:A.request,completed:A.completed,next_steps:A.next_steps,created_at:A.created_at,created_at_epoch:A.created_at_epoch})),prompts:M.map(A=>({id:A.id,content_session_id:A.content_session_id,prompt_number:A.prompt_number,prompt_text:A.prompt_text,project:A.project,platform_source:A.platform_source,created_at:A.created_at,created_at_epoch:A.created_at_epoch}))}}getOrCreateManualSession(e){let s=`manual-${e}`,t=`manual-content-${e}`;if(this.db.prepare("SELECT memory_session_id FROM sdk_sessions WHERE memory_session_id = ?").get(s))return s;let o=new Date;return this.db.prepare(`
      INSERT INTO sdk_sessions (memory_session_id, content_session_id, project, platform_source, started_at, started_at_epoch, status)
      VALUES (?, ?, ?, ?, ?, ?, 'active')
    `).run(s,t,e,p,o.toISOString(),o.getTime()),E.info("SESSION","Created manual session",{memorySessionId:s,project:e}),s}close(){this.db.close()}importSdkSession(e){let s=C(e.platform_source),t=this.db.prepare(`SELECT id FROM sdk_sessions
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...e,t??null,t??null,...r,...i,s.totalObservationCount)}function is(n,e,s,t){let r=e.map(()=>"?").join(",");return n.db.prepare(`
    SELECT
      ss.id,
    ...
    LIMIT ?
  `).all(...e,...e,t??null,t??null,s.sessionCount+ts)}function Lt(n){return n.replace(/[/.]/g,"-")}function Ct(n){if(!n.includes('"type":"assistant"'))return null;let e=JSON.parse(n);if(e.type==="assistant"&&e.message?.content&&Array.isArray(e.message.content)){let s="";for(let t of e.message.content)t.type==="text"&&(s+=t.text);if(s=s.replace(Ye,"").trim(),s)return s}return null}function ht(n){for(let e=n.length-1;e>=0;e--)try{let s=Ct(n[e]);if(s)return s}catch(s){s instanceof Error?E.debug("WORKER","Skipping malformed transcript line",{lineIndex:e},s):E.debug("WORKER","Skipping malformed transcript line",{lineIndex:e,error:String(s)});continue}return""}function ft(n){try{if(!(0,se.existsSync)(n))return{assistantMessage:""};let e=(0,se.readFileSync)(n,"utf-8").trim();if(!e)return{assistantMessage:""};let s=e.split(`
`).filter(r=>r.trim());return{assistantMessage:ht(s)}}catch(e){return e instanceof Error?E.failure("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n},e):E.warn("WORKER","Failed to extract prior messages from transcript",{transcriptPath:n,error:String(e)}),{assistantMessage:""}}}function as(n,e,s,t){if(!e.showLastMessage||n.length===0)return{assistantMessage:""};let r=n.find(_=>_.memory_session_id!==s);if(!r)return{assistantMessage:""};let o=r.memory_session_id,i=Lt(t),a=rs.default.join(ae,"projects",i,`${o}.jsonl`);return ft(a)}function Es(n,e){let s=e[0]?.id;return n.map((t,r)=>{let o=r===0?null:e[r+1];return{...t,displayEpoch:o?o.created_at_epoch:t.created_at_epoch,displayTime:o?o.created_at:t.created_at,shouldShowLink:t.id!==s}})}function _s(n,e){let s=[...n.map(t=>({type:"observation",data:t})),...e.map(t=>({type:"summary",data:t}))];return s.sort((t,r)=>{let o=t.type==="observation"?t.data.created_at_epoch:t.data.displayEpoch,i=r.type==="observation"?r.data.created_at_epoch:r.data.displayEpoch;return o-i}),s}function ds(n,e){return new Set(n.slice(0,e).map(s=>s.id))}function ms(){let n=new Date,e=n.toLocaleDateString("en-CA"),s=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function us(n){return[`# [${n}] recent context, ${ms()}`,""]}function Ts(){return[`Legend: \u{1F3AF}session ${D.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji}${s.id}`).join(" ")}`,"Format: ID TIME TYPE TITLE","Fetch details: get_observations([IDs]) | Search: mem-search skill",""]}function ps(n,e){let s=[],t=[`${n.totalObservations} obs (${n.totalReadTokens.toLocaleString()}t read)`,`${n.totalDiscoveryTokens.toLocaleString()}t work`];return n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)&&(e.showSavingsPercent?t.push(`${n.savingsPercent}% savings`):e.showSavingsAmount&&t.push(`${n.savings.toLocaleString()}t saved`)),s.push(`Stats: ${t.join(" | ")}`),s.push(""),s}function cs(n){return[`### ${n}`]}function ls(n){return n.toLowerCase().replace(" am","a").replace(" pm","p")}function Ns(n,e,s){let t=n.title||"Untitled",r=D.getInstance().getTypeIcon(n.type),o=e?ls(e):'"';return`${n.id} ${o} ${r} ${t}`}function Is(n,e,s,t){let r=[],o=n.title||"Untitled",i=D.getInstance().getTypeIcon(n.type),a=e?ls(e):'"',{readTokens:_,discoveryDisplay:d}=$(n,t);r.push(`**${n.id}** ${a} ${i} **${o}**`),s&&r.push(s);let m=[];return t.showReadTokens&&m.push(`~${_}t`),t.showWorkTokens&&m.push(d),m.length>0&&r.push(m.join(" ")),r.push(""),r}function Os(n,e){return[`S${n.id} ${n.request||"Session started"} (${e})`]}function j(n,e){return e?[`**${n}**: ${e}`,""]:[]}function Ss(n){return n.assistantMessage?["","---","","**Previously**","",`A: ${n.assistantMessage}`,""]:[]}function Rs(n,e){return["",`Access ${Math.round(n/1e3)}k tokens of past work via get_observations([IDs]) or mem-search skill.`]}function gs(n){return`# [${n}] recent context, ${ms()}

No previous sessions found.`}function As(){let n=new Date,e=n.toLocaleDateString("en-CA"),s=n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}).toLowerCase().replace(" ",""),t=n.toLocaleTimeString("en-US",{timeZoneName:"short"}).split(" ").pop();return`${e} ${s} ${t}`}function bs(n){return["",`${u.bright}${u.cyan}[${n}] recent context, ${As()}${u.reset}`,`${u.gray}${"\u2500".repeat(60)}${u.reset}`,""]}function Ls(){let e=D.getInstance().getActiveMode().observation_types.map(s=>`${s.emoji} ${s.id}`).join(" | ");return[`${u.dim}Legend: session-request | ${e}${u.reset}`,""]}function Cs(){return[`${u.bright}Column Key${u.reset}`,`${u.dim}  Read: Tokens to read this observation (cost to learn it now)${u.reset}`,`${u.dim}  Work: Tokens spent on work that produced this record ( research, building, deciding)${u.reset}`,""]}function hs(){return[`${u.dim}Context Index: This semantic index (titles, types, files, tokens) is usually sufficient to understand past work.${u.reset}`,"",`${u.dim}When you need implementation details, rationale, or debugging context:${u.reset}`,`${u.dim}  - Fetch by ID: get_observations([IDs]) for observations visible in this index${u.reset}`,`${u.dim}  - Search history: Use the mem-search skill for past decisions, bugs, and deeper research${u.reset}`,`${u.dim}  - Trust this index over re-reading code for past decisions and learnings${u.reset}`,""]}function fs(n,e){let s=[];if(s.push(`${u.bright}${u.cyan}Context Economics${u.reset}`),s.push(`${u.dim}  Loading: ${n.totalObservations} observations (${n.totalReadTokens.toLocaleString()} tokens to read)${u.reset}`),s.push(`${u.dim}  Work investment: ${n.totalDiscoveryTokens.toLocaleString()} tokens spent on research, building, and decisions${u.reset}`),n.totalDiscoveryTokens>0&&(e.showSavingsAmount||e.showSavingsPercent)){let t="  Your savings: ";e.showSavingsAmount&&e.showSavingsPercent?t+=`${n.savings.toLocaleString()} tokens (${n.savingsPercent}% reduction from reuse)`:e.showSavingsAmount?t+=`${n.savings.toLocaleString()} tokens`:t+=`${n.savingsPercent}% reduction from reuse`,s.push(`${u.green}${t}${u.reset}`)}return s.push(""),s}function Ds(n){return[`${u.bright}${u.cyan}${n}${u.reset}`,""]}function vs(n){return[`${u.dim}${n}${u.reset}`]}function Ms(n,e,s,t){let r=n.title||"Untitled",o=D.getInstance().getTypeIcon(n.type),{readTokens:i,discoveryTokens:a,workEmoji:_}=$(n,t),d=s?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),m=t.showReadTokens&&i>0?`${u.dim}(~${i}t)${u.reset}`:"",T=t.showWorkTokens&&a>0?`${u.dim}(${_} ${a.toLocaleString()}t)${u.reset}`:"";return`  ${u.dim}#${n.id}${u.reset}  ${d}  ${o}  ${r} ${m} ${T}`}function Us(n,e,s,t,r){let o=[],i=n.title||"Untitled",a=D.getInstance().getTypeIcon(n.type),{readTokens:_,discoveryTokens:d,workEmoji:m}=$(n,r),T=s?`${u.dim}${e}${u.reset}`:" ".repeat(e.length),l=r.showReadTokens&&_>0?`${u.dim}(~${_}t)${u.reset}`:"",I=r.showWorkTokens&&d>0?`${u.dim}(${m} ${d.toLocaleString()}t)${u.reset}`:"";return o.push(`  ${u.dim}#${n.id}${u.reset}  ${T}  ${a}  ${u.bright}${i}${u.reset}`),t&&o.push(`    ${u.dim}${t}${u.reset}`),(l||I)&&o.push(`    ${l} ${I}`),o.push(""),o}function ys(n,e){let s=`${n.request||"Session started"} (${e})`;return[`${u.yellow}#S${n.id}${u.reset} ${s}`,""]}function W(n,e,s){return e?[`${s}${n}:${u.reset} ${e}`,""]:[]}function Xs(n){return n.assistantMessage?["","---","",`${u.bright}${u.magenta}Previously${u.reset}`,"",`${u.dim}A: ${n.assistantMessage}${u.reset}`,""]:[]}function Fs(n,e){let s=Math.round(n/1e3);return["",`${u.dim}Access ${s}k tokens of past research & decisions for just ${e.toLocaleString()}t. Use the claude-mem skill to access memories by ID.${u.reset}`]}function xs(n){return`
...
`}function ws(n,e,s,t){let r=[];return t?r.push(...bs(n)):r.push(...us(n)),t?r.push(...Ls()):r.push(...Ts()),t&&(r.push(...Cs()),r.push(...hs())),ee(s)&&(t?r.push(...fs(e,s)):r.push(...ps(e,s))),r}var Re=K(require("path"),1);function re(n){if(!n)return[];try{let e=JSON.parse(n);return Array.isArray(e)?e:[]}catch(e){return E.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:n?.substring(0,50)},e instanceof Error?e:new Error(String(e))),[]}}function ge(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function Ae(n){return new Date(n).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function Gs(n){return new Date(n).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function ks(n,e){return Re.default.isAbsolute(n)?Re.default.relative(e,n):n}function Ps(n,e,s){let t=re(n);if(t.length>0)return ks(t[0],e);if(s){let r=re(s);if(r.length>0)return ks(r[0],e)}return"General"}function Dt(n){let e=new Map;for(let t of n){let r=t.type==="observation"?t.data.created_at:t.data.displayTime,o=Gs(r);e.has(o)||e.set(o,[]),e.get(o).push(t)}let s=Array.from(e.entries()).sort((t,r)=>{let o=new Date(t[0]).getTime(),i=new Date(r[0]).getTime();return o-i});return new Map(s)}function Bs(n,e){return e.fullObservationField==="narrative"?n.narrative:n.facts?re(n.facts).join(`
`):null}function vt(n,e,s,t){let r=[];r.push(...cs(n));let o="";for(let i of e)if(i.type==="summary"){let a=i.data,_=ge(a.displayTime);r.push(...Os(a,_))}else{let a=i.data,_=Ae(a.created_at),m=_!==o?_:"";if(o=_,s.has(a.id)){let l=Bs(a,t);r.push(...Is(a,m,l,t))}else r.push(Ns(a,m,t))}return r}function Mt(n,e,s,t,r){let o=[];o.push(...Ds(n));let i=null,a="";for(let _ of e)if(_.type==="summary"){i=null,a="";let d=_.data,m=ge(d.displayTime);o.push(...ys(d,m))}else{let d=_.data,m=Ps(d.files_modified,r,d.files_read),T=Ae(d.created_at),l=T!==a;a=T;let I=s.has(d.id);if(m!==i&&(o.push(...vs(m)),i=m),I){let b=Bs(d,t);o.push(...Us(d,T,l,b,t))}else o.push(Ms(d,T,l,t))}return o.push(""),o}function Ut(n,e,s,t,r,o){return o?Mt(n,e,s,t,r):vt(n,e,s,t)}function Hs(n,e,s,t,r){let o=[],i=Dt(n);for(let[a,_]of i)o.push(...Ut(a,_,e,s,t,r));return o}function $s(n,e,s){return!(!n.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||s&&e.created_at_epoch<=s.created_at_epoch)}function js(n,e){let s=[];return e?(s.push(...W("Investigated",n.investigated,u.blue)),s.push(...W("Learned",n.learned,u.yellow)),s.push(...W("Completed",n.completed,u.green)),s.push(...W("Next Steps",n.next_steps,u.magenta))):(s.push(...j("Investigated",n.investigated)),s.push(...j("Learned",n.learned)),s.push(...j("Completed",n.completed)),s.push(...j("Next Steps",n.next_steps))),s}function Ws(n,e){return e?Xs(n):Ss(n)}function Vs(n,e,s){return!ee(e)||n.totalDiscoveryTokens<=0||n.savings<=0?[]:s?Fs(n.totalDiscoveryTokens,n.totalReadTokens):Rs(n.totalDiscoveryTokens,n.totalReadTokens)}var yt=Ks.default.join((0,Ys.homedir)(),".claude","plugins","marketplaces","thedotmack","plugin",".install-version");function Xt(){try{return new z}catch(n){if(n instanceof Error&&n.code==="ERR_DLOPEN_FAILED"){try{(0,qs.unlinkSync)(yt)}catch(e){e instanceof Error?E.debug("WORKER","Marker file cleanup failed (may not exist)",{},e):E.debug("WORKER","Marker file cleanup failed (may not exist)",{error:String(e)})}return E.error("WORKER","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw n}}function Ft(n,e){return e?xs(n):gs(n)}function xt(n,e,s,t,r,o,i){let a=[],_=Se(e);a.push(...ws(n,_,t,i));let d=s.slice(0,t.sessionCount),m=Es(d,s),T=_s(e,m),l=ds(e,t.fullObservationCount);a.push(...Hs(T,l,t,r,i));let I=s[0],b=e[0];$s(t,I,b)&&a.push(...js(I,i));let g=as(e,t,o,r);return a.push(...Ws(g,i)),a.push(...Vs(_,t,i)),a.join(`
`).trimEnd()}var wt=new Set(["bugfix","discovery","decision","refactor"]);function kt(n,e,s){let t=Se(n),r={bugfix:0,discovery:0,decision:0,refactor:0,other:0},o=new Set,i=Number.POSITIVE_INFINITY;for(let _ of n){let d=wt.has(_.type)?_.type:"other";r[d]++,_.memory_session_id&&o.add(_.memory_session_id),_.created_at_epoch&&_.created_at_epoch<i&&(i=_.created_at_epoch)}let a=Number.isFinite(i)?Math.max(0,Math.floor((Date.now()-i)/864e5)):0;return{observation_count:n.length,session_count:o.size,timeline_depth_days:a,has_session_summary:e.length>0,obs_type_bugfix:r.bugfix,obs_type_discovery:r.discovery,obs_type_decision:r.decision,obs_type_refactor:r.refactor,obs_type_other:r.other,tokens_injected:t.totalReadTokens,tokens_saved_vs_naive:t.savings,search_strategy:s?"full":"timeline"}}async function be(n,e=!1){let s=es(),t=n?.cwd??process.cwd(),r=ue(t),o=n?.projects?.length?n.projects:r.allProjects,i=o[o.length-1]??r.primary;n?.full&&(s.totalObservationCount=999999,s.sessionCount=999999);let a=Xt();if(!a)return{text:"",stats:null};try{let _=n?.platformSource?C(n.platformSource):void 0,d=o.length>1?o:[i],m=os(a,d,s,_),T=is(a,d,s,_);return m.length===0&&T.length===0?{text:Ft(i,e),stats:null}:{text:xt(i,m,T,s,t,n?.session_id,e),stats:kt(m,T,!!n?.full)}}finally{a.close()}}async function Js(n,e=!1){return(await be(n,e)).text}0&&(module.exports={generateContext,generateContextWithStats});
